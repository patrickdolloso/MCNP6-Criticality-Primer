...
1 1 9.9270e-2 -1 5 -6 u=1 imp:n=1 $ universe 1: Pu-Ni soln
2 0  -1 6 -7 u=1 imp:n=1 $ void region above solution
3 2 8.636e-2 -2 #1 #2 u=1 imp:n=1 $ stainless steel
4 0 2 u=1 imp:n=1     $ void region outside cylinder
c Lattice cell cards
5 0 -8 9 -10 11 lat=1 fill=1 u=2 imp:n=1 
c Window Lattice cards
6 0  9 -12 11 -14 3 -4 fill=2 imp:n=1 $ fill card
c Void universe
7 0 -9:12:-11:14:-3:4  imp:n=0 $ void universe
...
kcode 5000 1 50 250
c   Source Cards
ksrc 0 0 19.62 35.58 0 19.62 71.16 0 19.62 0 35.58 19.62 
     35.58 35.58 19.62 71.16 35.58 19.62
c   Material Cards
